    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div class="relative pt-36 ml-auto">
            <div class="lg:w-2/3 text-center mx-auto">
                <h1 class="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">Engelli olmaktan gurur duyuyorum.<span class="text-primary dark:text-white"></span></h1>
                <p class="mt-8 text-gray-700 dark:text-gray-300">{{ Str::limit('Herkes Bir Engelli Adayıdır.',300) }}</p>
