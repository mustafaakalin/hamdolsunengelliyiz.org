<div class="text-gray-600 dark:text-gray-300 pt-36" id="testimonials">
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div class="mb-20 space-y-4 px-6 md:px-0">
            ...
            <p class="text-center">işitme engelli insanlar arasında birçok başarılı birey bulunmaktadır. </p>
        </div>
        <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
            @foreach ($hearings as $item)
            ...
            <div
                ...
                <div class="flex gap-4">
                    <img class="w-12 h-12 rounded-full"
                        src="{{ asset('images/hearing/'. $item->image )  }}"
                ...
                <p class="mt-8">{{ Str::limit($item->description,200) }}</p>
